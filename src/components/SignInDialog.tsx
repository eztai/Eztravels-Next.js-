...
import { LogIn, Facebook, Instagram } from 'lucide-react';
...
const SignInDialog: React.FC<SignInDialogProps> = ({ open, onOpenChange, onSignIn }) => {
        ...
        <div className="space-y-3 mt-4">
          {authProviders.map((provider) => (
            <Button 
              ...
              variant={provider.type === 'email' ? 'default' : 'outline'}
              className="w-full" 
              size="lg"
            >
